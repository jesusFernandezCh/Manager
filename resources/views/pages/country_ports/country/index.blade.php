@extends('layouts.app')
@section('title')
<h1 class="nav-title text-white"><i class="icon icon-globe s-18"></i> Countries</h1>
@endsection
@section('top-menu')
    {{-- header --}}
...
@section('maincontent')
{{-- modal create --}}
@include('pages.country_ports.country.create')
{{-- modal edit --}}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            {!! Form::open(['route'=>['country.destroy',$country],'method'=>'DELETE', 'class'=>'formlDinamic','id'=>'eliminarRegistro']) !!}
                                            <a href="{{ route('country.edit',$country) }}" class="btn btn-default btn-sm" title="Editar">
