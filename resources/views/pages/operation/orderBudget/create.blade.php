			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td>{!! Form::text('order_purchase', isset($order_budget[0]->order_purchase) ? $order_budget[0]->order_purchase : 0, [ 'class'=>'form-control r-0 light s-12', 'id'=>'order_purchase', 'readonly'=>'true']) !!}</td>
					...
					<tr>
						...
						<td>{!! Form::text('comtopay', isset($order_budget[0]->comtopay) ? $order_budget[0]->comtopay : null, [ 'class'=>'form-control r-0 light s-12 total_usd', 'id'=>'comtopay', 'onChange'=>'TotalPrice()']) !!}</td>
					</tr>
					<tr>
						<td colspan="5">{!! Form::label('comtoreceive',__('Coms. to receive'), ['class'=>'col-form-label s-12']) !!}</td>
						<td>{!! Form::text('comtoreceive', isset($order_budget[0]->comtoreceive) ? $order_budget[0]->comtoreceive : null, [ 'class'=>'form-control r-0 light s-12 total_usd', 'id'=>'comtoreceive', 'onChange'=>'TotalPrice()']) !!}</td>
					</tr>
					<tr>
						<td colspan="5">{!! Form::label('usd_budget',__('USD_Budget'), ['class'=>'col-form-label s-12']) !!}</td>
						<td>{!! Form::text('usd_budget', isset($order_budget[0]->usd_budget) ? $order_budget[0]->usd_budget : null, [ 'class'=>'form-control r-0 light s-12', 'id'=>'usd_budget', 'onChange'=>'TotalPrice()', 'readonly'=>'true']) !!}</td>
					</tr>
				</tbody>
			</table>
			<br>
