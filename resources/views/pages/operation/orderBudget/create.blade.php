...
<div class="row">
		...
		<div class="col-md-3">
			{!! Form::text('order_quantity_budget', 0, [ 'class'=>'form-control r-0 light s-12', 'id'=>'order_quantity_budget', 'readonly'=>'true']) !!}
		</div>
			...
			<table>
				...
				<tbody>
					<tr>
						...
						<td>{!! Form::text('order_sale', 0, [ 'class'=>'form-control r-0 light s-12', 'id'=>'order_sale' , 'readonly'=>'true']) !!}</td>
						...
						<td width="80">{!! Form::text('order_sale_currency_change', null, [ 'class'=>'form-control r-0 light s-12', 'id'=>'order_sale_currency_change','readonly'=>'true']) !!}</td>
						<td width="50"> > USD</td>
						<td>{!! Form::text('order_sale_usd', null, [ 'class'=>'form-control r-0 light s-12 total_usd', 'id'=>'order_sale_usd','readonly'=>'true']) !!}</td>
					</tr>
					<tr>
						<td>{!! Form::label('order_purchase',__('OrderPurchase'), ['class'=>'col-form-label s-12']) !!}</td>
						<td>{!! Form::text('order_purchase', 0, [ 'class'=>'form-control r-0 light s-12', 'id'=>'order_purchase', 'readonly'=>'true']) !!}</td>
						...
						<td width="80">{!! Form::text('order_purchase_change', null, [ 'class'=>'form-control r-0 light s-12', 'id'=>'order_purchase_change','readonly'=>'true']) !!}</td>
						<td width="50"> > USD</td>
						<td>{!! Form::text('order_purchase_usd', null, [ 'class'=>'form-control r-0 light s-12 total_usd', 'id'=>'order_purchase_usd','readonly'=>'true']) !!}</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>{!! Form::text('usd_budget', null, [ 'class'=>'form-control r-0 light s-12', 'id'=>'usd_budget', 'onChange'=>'TotalPrice()', 'readonly'=>'true']) !!}</td>
					</tr>
				</tbody>
			</table>
			<br>
