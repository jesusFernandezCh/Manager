...
$(document).ready(function() {
    ...
    $('#addRow').on( 'click', function () {
        t.row.add( [
            "<input type='number' name='order_quantity[]' class='form-control order_quantity r-0 light s-12 order_quantity' id='order_quantity"+i+"' onChange='calcular(\"order_quantity\", \"order_quantity_budget\"), cEstPSale_EstSale("+i+",this.value,\"sale_price\",\"est_sale\"),  cEstPSale_EstSale("+i+",this.value,\"purchase_price\",\"est_purchase_sale\"), calcular(\"est_purchase_sale\",\"order_sale\"), calcular(\"est_sale\", \"order_purchase\")'/>",
            ...
            "<input type='text' name='purchase_price[]' class='form-control r-0 light s-12 purchase_price' id='purchase_price"+i+"' onChange='cEstPSale_EstSale("+i+",this.value,\"order_quantity\",\"est_purchase_sale\"), calcular(\"est_purchase_sale\", \"order_sale\")'/>",
            "<input type='text' name='est_purchase_sale[]' class='form-control r-0 light s-12 est_purchase_sale' id='est_purchase_sale"+i+"' readonly/>",
            "<input type='text' name='sale_price[]' class='form-control r-0 light s-12 sale_price' id='sale_price"+i+"' onChange='cEstPSale_EstSale("+i+",this.value,\"order_quantity\",\"est_sale\"), calcular(\"est_sale\", \"order_purchase\")'/>",
            "<input type='text' name='est_sale[]' class='form-control r-0 light s-12 est_sale' id='est_sale"+i+"' onClick ='inputClear(this.id)' readonly/>",
        ] ).draw( false );
        i++;
    } );
