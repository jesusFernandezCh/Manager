    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel"><i class="icon-eye"></i> Currency Edit</h4>
                    ...
                    <div class="col-md-12">
                        <div class="form-row">
                            <div class="form-group col-6 m-0" id="symbol_group">
                                ...
                                {!! Form::text('symbol', null, ['class'=>'form-control r-0 light s-12',  'id'=>'_symbol', 'onclick'=>'inputClear(this.id)']) !!}
