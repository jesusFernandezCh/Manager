	            ...
	            <div class="card">
	                <div class="form-group">
	                    <div class="card-header white">
	                        <h6><i class="icon-pencil"></i>{{ __('EDIT DOCUMENT') }}</h6>
	                    </div>
	                </div>
	                <div class="card-body">
						{!! Form::model($document,['route'=>["document.update",$document->id],'method'=>'PUT','id'=>'DataUpdate']) !!}
						<div class="col-md-12">
	                        <div class="form-row">
						...
						<div class="col-md-12 text-right">
							<a href="{{ route('document.index') }}" class="btn btn-default" data-dismiss="modal">Back</a>
