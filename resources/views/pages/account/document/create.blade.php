				...
				<div class="form-row">
					<div class="col-md-12">
						<div class="form-row">
							...
							<div class="form-group col-4 m-0" id="name_group">
								<i class="icon icon-cogs mr-2"></i>
								{!! Form::label('operation', 'Operation', ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}
								{!! Form::select('operation_id', $operation, null, ['class'=>'form-control r-0 light s-12', 'id'=>'operation', 'onclick'=>'inputClear(this.id)']) !!}
