	...
	<div class="modal-dialog modal-lg" role="accountMeta">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel"><i class="icon icon-goals-1"></i> Add New Account Meta</h4>
					...
					<div class="col-md-12">
						<div class="form-row">
							<div class="form-group col-4 m-0" id="value_group">
								...
								{!! Form::label('account', 'Account', ['class'=>'col-form-label s-12', 'onclick'=>'inputClear(this.id)']) !!}
